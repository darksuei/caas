        ...
        <Routes>
          <Route element={<AuthLayout />}>
            <Route path="/" element={<MainLayout />}>
              ...
              <Route path="/onboarding/edit/:onboardingId" element={<ChurchEdit />} />
              <Route path="/onboarding/view/:onboardingId" element={<ParishView />} />
              <Route path="/biometrics" element={<Biometrics />} />
              <Route path="/biometrics/addbiometrics" element={<AddBiometrics />} />
